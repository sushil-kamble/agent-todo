function AgentMark({ className = '' }: { className?: string }) {
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute -right-[3px] -bottom-[3px] size-1 bg-primary" />
    </span>
  )
}
...
export function Footer() {
  return (
    <footer className="border-t border-border bg-background">
      <div className="mx-auto flex w-full max-w-[1400px] items-center justify-between gap-3 px-8 py-3">
