    ...
    >
      ...
      <header className="flex items-center justify-between border-b border-border bg-background/60 px-4 py-3">
        <div className="flex items-center gap-2.5">
          ...
          <h2 className="font-heading text-xl leading-none text-foreground">
            {column.label}
          </h2>
      ...
      <p className="border-b border-dashed border-border px-4 py-1.5 text-[0.6rem] tracking-[0.12em] text-muted-foreground/80 uppercase">
        {column.hint}
      </p>
